...
/*lianghao1@PSW.MM.Display.LCD.Stability,2021/10/16,add for reading panel serial number*/
...
#ifdef OPLUS_BUG_STABILITY
/*liwei.a@PSW.MM.Display.LCD.Stability,2021/05/12,add for reading panel serial number*/
#define PANEL_SERIAL_NUM_REG 0xA1
#define PANEL_REG_READ_LEN   10
/*chenjun@PSW.MM.Display.LCD.Stability,2021/12/23,add for silky brightness*/
			...
			bool blocking)
{
	...
	if (is_frame_mode) {
		...
		/* delete for fix thread 0/6 issue cmdq timeout */
		cmdq_pkt_clear_event(cmdq_handle,
